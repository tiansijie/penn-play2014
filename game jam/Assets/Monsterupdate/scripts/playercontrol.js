...
private var v3_randomDir : Vector3;
...
private function GetRandomDir() : void {
	v3_randomDir = new Vector3(Random.Range(-1.0,1.0), 0.0, Random.Range(-1.0,1.0));
}

private function GetReverseDir() : void {
	v3_randomDir = -Vector3.forward;
}
...
public function Update() : void {
	...
	var f_hor : float = v3_randomDir.x;//Input.GetAxis("Horizontal");
	//Get Vertical move - move forward or backward
	var f_ver : float = v3_randomDir.z;//Input.GetAxis("Vertical");
